" basic-dark -- A simple dark theme.
"
" most of the code copyed from Tomorrow-Night theme
" see: https://github.com/chriskempson/tomorrow-theme.git
" http://chriskempson.com
"
" Hex colour conversion functions borrowed from the theme "Desert256""

" Default GUI Colours
let s:foreground = "eeeeec"
let s:background = "111111"
let s:selection = "666666"
let s:line = "202020"
let s:comment = "b0b0b0"
let s:red = "c75646"
let s:orange = "d0b03c"
let s:yellow = "fff59d"
let s:green = "8eb33b"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("StatusLine", s:window, s:foreground, "reverse,italic")
	call <SID>X("StatusLineNC", s:window, s:selection, "reverse,italic")
	...
	call <SID>X("Todo", s:aqua, s:background, "underline")
	...
	call <SID>X("pythonRepeat", s:blue, "", "")
	call <SID>X("pythonExClass", s:red, "", "bold")
